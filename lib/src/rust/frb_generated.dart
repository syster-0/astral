...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 966098708;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<BigInt> crateApiAstralWfpWfpControllerAddAdvancedNetworkFilter({
    required WfpController that,
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_box_autoadd_filter_rule(rule, serializer);
        ...
        constMeta:
            kCrateApiAstralWfpWfpControllerAddAdvancedNetworkFilterConstMeta,
  ...
  TaskConstMeta
  get kCrateApiAstralWfpWfpControllerAddAdvancedNetworkFilterConstMeta =>
      const TaskConstMeta(
        debugName: "WfpController_add_advanced_network_filter",
  ...
  TaskConstMeta get kCrateApiAstralWfpFilterRuleValidateConstMeta =>
      const TaskConstMeta(
        debugName: "filter_rule_validate",
        argNames: ["that"],
      );
  ...
  FilterRule dco_decode_filter_rule(dynamic raw) {
    ...
    return FilterRule(
      ...
      local: dco_decode_opt_String(arr[2]),
      remote: dco_decode_opt_String(arr[3]),
      localPort: dco_decode_opt_box_autoadd_u_16(arr[4]),
      remotePort: dco_decode_opt_box_autoadd_u_16(arr[5]),
      protocol: dco_decode_opt_box_autoadd_protocol(arr[6]),
      direction: dco_decode_direction(arr[7]),
      action: dco_decode_filter_action(arr[8]),
    );
  }
  ...
  FilterRule sse_decode_filter_rule(SseDeserializer deserializer) {
    ...
    var var_remote = sse_decode_opt_String(deserializer);
  ...
  void sse_encode_filter_rule(FilterRule self, SseSerializer serializer) {
    ...
    sse_encode_opt_String(self.remote, serializer);
...
class WfpControllerImpl extends RustOpaque implements WfpController {
  ...
  Future<BigInt> addAdvancedNetworkFilter({
    ...
    required Guid layerKey,
      ...
      .crateApiAstralWfpWfpControllerAddAdvancedNetworkFilter(
        that: this,
        rule: rule,
        layerKey: layerKey,
      );
