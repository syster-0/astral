...
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(::prost_reflect::ReflectMessage)]
#[prost_reflect(message_name = "common.PortForwardConfigPb")]
#[prost_reflect(file_descriptor_set_bytes = "crate::proto::DESCRIPTOR_POOL_BYTES")]
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct PortForwardConfigPb {
    #[prost(message, optional, tag = "1")]
    pub bind_addr: ::core::option::Option<SocketAddr>,
    #[prost(message, optional, tag = "2")]
    pub dst_addr: ::core::option::Option<SocketAddr>,
    #[prost(enumeration = "SocketType", tag = "3")]
    pub socket_type: i32,
}
#[derive(serde::Serialize, serde::Deserialize)]
